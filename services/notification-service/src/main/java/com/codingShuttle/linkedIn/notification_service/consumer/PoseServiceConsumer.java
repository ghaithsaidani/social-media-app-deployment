...
public class PoseServiceConsumer {
    ...
    public void  handelPostCreated(String postCreatedEventsString){
        Gson gson = new Gson();
        log.info("Sending the notification for the created POST: {}",postCreatedEventsString);
        try {
    ...
    public void  handelPostLiked(String postLikeEventString){
        Gson gson=new Gson();
        log.info("Sending the notification for the created POST: {}",postLikeEventString);
        try {
